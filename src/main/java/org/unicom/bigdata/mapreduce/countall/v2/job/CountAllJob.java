package org.unicom.bigdata.mapreduce.countall.v2.job;
...
import org.unicom.bigdata.mapreduce.countall.v2.mapper.CountAllMapper;
import org.unicom.bigdata.mapreduce.countall.v2.reducer.CountAllReducer;
    ...
    public static void main(String[] args) throws Exception {
        if (args.length!=2){
            ...
            if (inputPath == null || inputPath == "" || outputPath == null || outputPath == ""){
                ...
                //给当前job类的对象设置job名称
                countAllJob.setJobName("count all v2");
