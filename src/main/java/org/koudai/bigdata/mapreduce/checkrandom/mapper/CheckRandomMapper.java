package org.koudai.bigdata.mapreduce.checkrandom.mapper;
...
/**
 * @description data maker 程序中的映射器
 * @Auther: 韩金铭 1329674322@qq.com
 * @Date: 2018/9/25 14:13
 */
public class CheckRandomMapper extends Mapper<LongWritable, Text,Text,IntWritable> {
    /**
     * 自定义映射器中的映射方法
     * 具体效果:line -->list(k,v)
     *
