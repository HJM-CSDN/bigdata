package org.koudai.bigdata.mapreduce.topnmmy.job;
...
import org.koudai.bigdata.mapreduce.topnmmy.mapper.TOPNMapper;
import org.koudai.bigdata.mapreduce.topnmmy.reducer.TOPNReducer;
    ...
    public static void main(String[] args) throws Exception{
        if (args.length!=3){
            ...
            if (inputPath == null || inputPath == "" || outputPath == null || outputPath == ""){
                ...
                //设置运行主类
                TOPNJob.setJarByClass(org.koudai.bigdata.mapreduce.topn.job.TOPNJob.class);
